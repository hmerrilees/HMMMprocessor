...
VL_ATTR_COLD void Vhmmm___024root__trace_init_sub__TOP__0(Vhmmm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+8,"RegWriteDest", false,-1);
    ...
    tracep->declBus(c+19,"alu_result", false,-1, 15,0);
    tracep->declBus(c+20,"alu_src_a", false,-1, 15,0);
    tracep->declBus(c+21,"alu_src_b", false,-1, 15,0);
    tracep->declBus(c+22,"rf_read_data_1", false,-1, 15,0);
    tracep->declBus(c+23,"rf_read_data_2", false,-1, 15,0);
    tracep->declBus(c+24,"rf_read_data_3", false,-1, 15,0);
    ...
    tracep->declBus(c+33,"ImmExt", false,-1, 15,0);
    tracep->pushNamePrefix("alu ");
    tracep->declBus(c+11,"alu_op", false,-1, 31,0);
    tracep->declBus(c+20,"src_a", false,-1, 15,0);
    tracep->declBus(c+21,"src_b", false,-1, 15,0);
    tracep->declBus(c+19,"alu_result", false,-1, 15,0);
    tracep->declBit(c+30,"zero", false,-1);
    tracep->declBit(c+31,"sign", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+8,"write_dest", false,-1);
    tracep->declBit(c+7,"write_en", false,-1);
    tracep->declBus(c+18,"write_data", false,-1, 15,0);
    tracep->declBus(c+22,"read_data_1", false,-1, 15,0);
    tracep->declBus(c+23,"read_data_2", false,-1, 15,0);
    tracep->declBus(c+24,"read_data_3", false,-1, 15,0);
    for (int i = 0; i < 16; ++i) {
...
VL_ATTR_COLD void Vhmmm___024root__trace_full_sub_0(Vhmmm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(vlSelf->hmmm__DOT__RegWrite));
    bufp->fullBit(oldp+8,(vlSelf->hmmm__DOT__RegWriteDest));
    ...
    bufp->fullSData(oldp+18,(vlSelf->hmmm__DOT__datapath__DOT__result),16);
    bufp->fullSData(oldp+19,(vlSelf->hmmm__DOT__datapath__DOT__alu_result),16);
    bufp->fullSData(oldp+20,(vlSelf->hmmm__DOT__datapath__DOT__alu_src_a),16);
    bufp->fullSData(oldp+21,(vlSelf->hmmm__DOT__datapath__DOT__alu_src_b),16);
    bufp->fullSData(oldp+22,(vlSelf->hmmm__DOT__datapath__DOT__rf_read_data_1),16);
    bufp->fullSData(oldp+23,(vlSelf->hmmm__DOT__datapath__DOT__rf_read_data_2),16);
    bufp->fullSData(oldp+24,(((0U == (0xfU & (IData)(vlSelf->hmmm__DOT__Instr)))
                                   ...
                                   : ((0x16U == vlSelf->hmmm__DOT__instruction_type)
                                       ...
                                       : ((0x17U == vlSelf->hmmm__DOT__instruction_type)
                                           ...
                                           : ((0x18U 
                                              ...
                                              | ((IData)(vlSelf->hmmm__DOT__datapath__DOT__alu_result) 
                                                 >> 0xfU))))))));
    bufp->fullSData(oldp+33,(vlSelf->hmmm__DOT__datapath__DOT__ImmExt),16);
